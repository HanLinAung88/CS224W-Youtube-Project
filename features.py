...
def get_vars(fname, fname_extended):
	...
	Graph, dict_to_graph, graph_to_dict = utils.load_graph_undirected(video_dict_list)
	neighbors = get_neighbors(Graph)
	fields = ['views', 'ratings', 'comments']
    
	video_dict_list.update(video_dict_list_extended)

	return Graph, video_dict_list, graph_to_dict, neighbors, fields
...
def main():
	...
	G, video_dict_list, graph_to_dict, neighbors, fields = get_vars
	feature_dict = get_feature_dict(G, video_dict_list, graph_to_dict, neighbors, fields)
